package com.mobileapp.b1_2_toan_b1704780;
...
// Handle item selection
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.item1:
                //Toast.makeText(this, "Bộ phận tiếp thị; \n Bộ phận nhập hàng; \nBộ phận giao hàng; \n Bộ phận kế toán;", Toast.LENGTH_LONG).show(); ;
            ...
            case R.id.item2_1:
                ...
                return true;
            case R.id.item2_2:
//Toast.makeText(this, "1. Nguyễn văn A; \n 2. Lâm Văn Mới;",Toast.LENGTH_LONG).show();
...
//Lập trình hành động khi chọn item.
        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.item3_1: btnpopup.setText("MENU COPY");// Đổi tên nút
                        break;
                }
                switch (item.getItemId()) {
