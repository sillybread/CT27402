...
/**
 * Created by Doan Hoa Minh on 12-Mar-18.
 */
public class DBAdapter {
    /* Định nghĩa các hằng số để chứa các trường khác nhau cho các bảng mà ta sẽ tạo
   ra trong CSDL.*/
    static final String KEY_ROWID = "_id";
    static final String KEY_MSSV = "mssv";
    static final String KEY_NAME = "name";
    static final String KEY_EMAIL = "email";
    static final String KEY_SDT = "sdt";
    ...
    static final String DATABASE_CREATE =
            "create table students (_id integer primary key autoincrement, "
                    + "mssv text not null, name text not null, email text not null, sdt text not null);";
    //Hàm tạo (contractor)
    ...
    public long insertStudent(String name, String mssv, String email, String sdt)
    {
        ContentValues initialValues = new ContentValues();
        initialValues.put(KEY_NAME, name);
        initialValues.put(KEY_MSSV, mssv);
        initialValues.put(KEY_EMAIL, email);
        initialValues.put(KEY_SDT, sdt);
    ...
    public Cursor getAllStudent()
    {
        return db.query(DATABASE_TABLE, new String[] {KEY_ROWID, KEY_MSSV, KEY_NAME,
                KEY_EMAIL, KEY_SDT}, null, null, null, null, null);
    }
    ...
    public Cursor getStudent(int chiso) throws SQLException
    {
        Cursor mCursor =
                db.query(true, DATABASE_TABLE, new String[] {KEY_ROWID, KEY_MSSV,
                                KEY_NAME, KEY_EMAIL, KEY_SDT}, KEY_ROWID + "=" + chiso, null,
                        null, null, null, null);
        if (mCursor != null) {
            mCursor.moveToFirst();
        }
    ...
    public boolean updateStudent(long rowId, String mssv, String name, String email, String sdt)
    {
        ContentValues args = new ContentValues();
        args.put(KEY_MSSV, mssv);
        args.put(KEY_NAME, name);
        args.put(KEY_EMAIL, email);
        args.put(KEY_SDT, sdt);
