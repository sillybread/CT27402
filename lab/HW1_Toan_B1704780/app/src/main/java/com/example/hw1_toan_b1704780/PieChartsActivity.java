            ...
            public void onClick(View v) {
                ...
                switch (vitri) {
                    case 2:
                        ...
                        DecimalFormat df= new DecimalFormat("0.0");
                        // số thập phân, muốn bao nhiêu chữ số sau dấu phẩy //thì thêm bấy nhiêu số 0.
...
//tổng số liệu nhập vào
                    ...
                    case 3:
                        ...
                        //tính số phần trăm từng phần số thập phân, muốn bao nhiêu chữ số sau dấu phẩy //thì thêm bấy nhiêu số 0.
...
//tổng số liệu nhập vào
                    ...
                    case 6:
                        ...
                        amount6 = Double.parseDouble(edtso6.getText().toString());
                        //tính số phần trăm từng phần
                        DecimalFormat df3456 = new DecimalFormat("0.0");// làm tròn với 3 số thập phân, muốn bao nhiêu chữ số sau dấu phẩy //thì thêm bấy nhiêu số 0.
                        double tong3pt456 = amount1 + amount2 + amount3 + amount4 + amount5 + amount6;
                        double in13456 = ((amount1 / tong3pt456) * 100);
                        double in23456 = ((amount2 / tong3pt456) * 100);
                        double in33456 = ((amount3 / tong3pt456) * 100);
                    ...
                    case 7:
                        ...
                        amount7 = Double.parseDouble(edtso7.getText().toString());
                        //tính số phần trăm từng phần
                        DecimalFormat df34567 = new DecimalFormat("0.0");// làm tròn với 3 số thập phân, muốn bao nhiêu chữ số sau dấu phẩy //thì thêm bấy nhiêu số 0.
                        double
                                tong3pt4567 = amount1 + amount2 + amount3 + amount4 + amount5 + amount6 + amount7;
                        double in134567 = ((amount1 / tong3pt4567) * 100);
                        double in234567 = ((amount2 / tong3pt4567) * 100);
                    ...
                    case 9:
                        ...
                        amount9 = Double.parseDouble(edtso9.getText().toString());
                        //tính số phần trăm từng phần
                        DecimalFormat df3456789 = new DecimalFormat("0.0");// làm tròn với 3 số thập phân, muốn bao nhiêu chữ số sau dấu phẩy //thì thêm bấy nhiêu số 0.
                        double
                                tong3pt456789 = amount1 + amount2 + amount3 + amount4 + amount5 + amount6 + amount7 + amount8 + amount9;
                        double in13456789 = ((amount1 / tong3pt456789) * 100);
                        double in23456789 = ((amount2 / tong3pt456789) * 100);
...
//
    ...
    private void setData7(int count, float range) {
        ...
        float mult = range;
        ArrayList<PieEntry> yEntrys = new ArrayList<>();
        // ArrayList<PieEntry> entries = new ArrayList<PieEntry>(); their position
        // around the center of the chart.
